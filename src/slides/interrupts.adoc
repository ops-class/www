...
image::women/036.jpg[width="100%",title="Shafrira Goldwasser", link="https://en.wikipedia.org/wiki/Shafi_Goldwasser"]
...
* What are the *consequences* for programmers of processor
...
[.slider]
* Multiplexing the CPU: how and why.
* Context switching and thread context.
