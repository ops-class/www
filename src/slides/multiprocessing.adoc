...
* `test161` submit should be done shortly. If needed, we'll push the ASST1
due date. (But don't plan on it.)
...
* Also note that the video for yesterday's recitation will not be posted.
