...
[.h4.center]
icon:music[] http://lanadelrey.com/[{song}]
...
will discuss this today. Example: VirtualBox.
//
...
this paper for Wednesday. Example: Xen, Amazon EC2.
//
* *Container virtualization*. Namespace and other isolation techniques
performed _by the operating system_ to isolate sets of applications from each
other. Example: Docker (with augmentations.)
