...
https://www.ops-class.org/mailman/listinfo/ub
...
* Analogous to older computers that would transform a set of punchcards
into a "result."
...
loading, etc.
* Loading webpages--usually multiple parts _in parallel_ to speed
things up.
