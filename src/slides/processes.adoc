...
video::{music}[youtube,width=480,height=270]
...
* Videos are up. (Sorry they're blurry--we'll fix that starting today.)
* Recitations will start next week.
* The add/drop deadline is *next Monday February 6th.*
** You still have time to examine the assignments and
