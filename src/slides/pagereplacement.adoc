...
[.h4.center]
icon:music[] http://teganandsara.com/[{song}]
...
** Leave everything else at the front, back, or sides of the room: coats,
bags, *smartphones*.
...
* *Smartphone use during the exam will result in immediate ejection and
failure.*
...
* link:/asst/3/[ASST3.1] is due _a week after the midterm_.
...
[.slider]
* On certain (common) architectures the MMU will search the page table *itself*
