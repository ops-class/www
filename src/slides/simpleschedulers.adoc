...
description: >
  ...
  round-robin), oracle schedulers, and multi-level feedback queues.
song:
  name: "Shake It Off"
  author: "Taylor Swift"
  youtube: nfWlot6h_JM
...
*Priorities* and lottery *tickets* are examples of scheduling abstractions
that we use to help think about how to make scheduling decisions.
