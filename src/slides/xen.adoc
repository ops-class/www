...
[.small]
____
Efficient virtualizion of privilege levels is possible on x86 because it
...
generally used for application code. *To our knowledge, rings 1 and 2 have not
been used by any well-known x86 OS since OS/2.*
____
