...
[.center]
icon:music[] http://ohdaughter.com[{song}]
...
* *link:/asst/1/[ASST1] is due today at 5PM.*
* We have office hours all day long...
...
* Context switching creates the *cost* to enter the kernel (or cross the
user/kernel boundary) and perform a system call.
